const onboarding_screens = [
  {
    id: 1,
    backgroundImage: require('../assets/images/barber3.jpg'),
    bannerImage: require('../assets/images/favourite_food.png'),
    title: 'The professional Specialist in near by',
    description:
      'Get an overview of how you are performing & motivate yourself to achieve even more',
  },
  {
    id: 2,
    backgroundImage: require('../assets/images/barberBanner1.jpg'),
  ...
  {
    id: 3,
    backgroundImage: require('../assets/images/barberBanner2.jpg'),
